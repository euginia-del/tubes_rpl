...
<div class="md:hidden bg-white dark:bg-slate-800 shadow-sm sticky top-0 z-40">
    <div class="flex items-center justify-between px-4 py-3">
        ...
        <span class="text-lg font-bold bg-gradient-to-r from-primary to-secondary bg-clip-text text-transparent">Pricing</span>
...
<div class="md:ml-72">
    <div class="container-responsive py-6">
        <h1 class="text-2xl md:text-3xl font-bold text-gray-800 dark:text-white mb-6 hidden md:block">Our Service Prices</h1>

        <div class="grid md:grid-cols-2 gap-6">
            <?php foreach ($services as $service): ?>
            <div class="bg-white dark:bg-slate-800 rounded-2xl shadow-lg overflow-hidden card-animate hover-lift">
        ...
        <div class="bg-white dark:bg-slate-800 rounded-2xl p-12 text-center">
            <span class="material-symbols-outlined text-6xl text-gray-400">info</span>
            <p class="text-gray-500 dark:text-gray-400 mt-4">No pricing information available</p>
        </div>
        <?php endif; ?>
    </div>
</div>
